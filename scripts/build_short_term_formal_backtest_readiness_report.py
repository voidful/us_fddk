...
def _site_summary(result: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "synthetic_control": {
            ...
            "global_search_trials": control["policy"]["statistics"][
        ...
        "actual_point_in_time_readiness": result[
        ...
        "risk_free_provider_input_received": result[
            "risk_free_provider_input_received"
        ],
...
def main() -> int:
    ...
    print(
        json.dumps(
            {
                "status": result["status"],
                "synthetic_gate_summary": result["synthetic_control"][
                    "gate_summary"
                ],
                "attack_summary": result["attack_summary"],
                "actual_formal_readiness": result["actual_formal_readiness"],
